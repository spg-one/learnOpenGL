...
void processInput(GLFWwindow *window)
{
    ...
    if (glfwGetKey(window, GLFW_KEY_UP) == GLFW_PRESS && sem_up == 1)
    {
        sem_up--;
        mix += 0.1;
    ...
    if (glfwGetKey(window, GLFW_KEY_UP) == GLFW_RELEASE && sem_up == 0)
    {
        sem_up++;
    }
    if (glfwGetKey(window, GLFW_KEY_DOWN) == GLFW_PRESS && sem_down == 1)
    {
        sem_down--;
        mix -= 0.1;
    ...
    if (glfwGetKey(window, GLFW_KEY_DOWN) == GLFW_RELEASE && sem_down == 0)
    {
        sem_down++;
    }
}
